<?php
    ...
    class EquipamentoDAO{
        ...
        public function listarPorModeloEquipamento($modelo_equipamento){
    		...
    		$pdo = PDOFactory::getConexao();
            $comando = $pdo->prepare($query);
            $patri_equipamento = '%'.$modelo_equipamento.'%';
        ...
        public function inserir(Equipamento $equipamento){
            $qInserir = "INSERT INTO equipamentos(patri_equipamento, modelo_equipamento, nro_serie_equipamento,
        ...
        public function atualizar(Equipamento $equipamento){
            $qAtualizar = "UPDATE equipamento SET id_equipamento=:id_equipamento, 
            ...
            local_equipamento=:local_equipamento, observacao=:observacao WHERE id_equipamento=:id";            
            $pdo = PDOFactory::getConexao();
