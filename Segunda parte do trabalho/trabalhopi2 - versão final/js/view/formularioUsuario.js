class FormUsuario {
          ...
          <form id="formulario">
            <div class="form-row">
              <div class="col-md-2 mb-3">
                ...
                <input type="text" disabled id="txtIdUsuario" class="form-control" value="${usuario.id_usuario ? usuario.id_usuario : ''}">
               </div>
              <div class="col-md-10 mb-3">
                <label for="txtNomeUsuario">Nome do Usuário: </label>
                <input type="text" id="txtNomeUsuario" class="form-control" value=${usuario.nome_usuario ? usuario.nome_usuario : ''}>
              </div>
              <br />
              <br />
              <div class="col-md-6 mb-3">
                <label for="txtLoginUsuario">Login: </label>
                <input type="text" id="txtLoginUsuario" class="form-control" value=${usuario.login_usuario ? usuario.login_usuario : ''}>
              </div>
              <br />
              <br />
              <div class="col-md-6 mb-3">
                ...
                class="form-control" value=${usuario.senha_usuario ? usuario.senha_usuario : ''}>
              </div>
              <br />
              <br />
  ...
  getDataUsuario () {
    ...
    if (!document.querySelector('#txtIdUsuario').value) {
      usuario.id_usuario = document.querySelector('#txtIdUsuario').value
