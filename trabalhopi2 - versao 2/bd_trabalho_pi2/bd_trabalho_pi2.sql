...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Set-2019 às 23:27
...
INSERT INTO `equipamentos` (`id_equipamento`, `patri_equipamento`, `modelo_equipamento`, `nro_serie_equipamento`, `data_aquisicao`, `nro_nota_fiscal`, `local_equipamento`) VALUES
(1, 100000, 'MICRO PENTIUM INTEL I7 - DDR3 2GB - 160GB', 'GI0727/14', '2014-04-21', 555122534, '11662 - HCO-ARQ MED E ESTATISTICA'),
(2, 100001, 'MICRO PENTIUM CORE2 DUO- HD 160GB - 1GB MB - MARCA: HP', 'BRG838F9W2', '2009-10-12', 42586547, '11803 - HCO-CONTROLE DE INFECCAO'),
(3, 137024, 'MICRO AMD DUAL CORE 2.3 - 1GB - HD 160GB - LENOVO', '6234DG2L1BFRDZ', '2010-09-30', 253547, '11803 - HCO-CONTROLE DE INFECCAO'),
(4, 112837, 'MICROCOMPUTADOR PENTIUM INTEL I5  - 1TB HD - DDR4 4 GB', 'GI0466/14', '2019-09-24', 36857441, '11757 - HCO-LAB FUNCAO E REAB PULMONAR'),
(5, 134833, 'MICROCOMPUTADOR INTEL CORE I7, HD-160GB, 2 GB RAM', 'GI0194/12', '2011-11-06', 395874512, '90000 - GHC-DIRETORIA'),
(6, 144503, 'MICROCOMPUTADOR DO TIPO DESKTOP LENOVO', 'PE81263', '2010-08-03', 253497628, '21870 - HCO-EMERGENCIA / ENFERM'),
...
(2, 'cleissom', 'clei123', 'Cleissom'),
(3, 'esta', 'esta11', 'Estagiario'),
(4, 'mmm', 'mmm', 'Marcello'),
(5, 'eliz', 'ez12', 'Eli'),
(6, 'cars', 'cat15', 'Carla'),
(7, 'leob', 'leoc', 'Leonardo');
...
ALTER TABLE `chamados`
  ...
  ADD CONSTRAINT `fk_patri_equipamento` FOREIGN KEY (`patri_equipamento`) REFERENCES `equipamentos` (`id_equipamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
